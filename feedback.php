...
<div class="col-md-10">
<a href="mailto:manisinghasd@gmail.com" style="color:#000000">manisinghasd@gmail.com</a><br /><br />
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/mani.jpg" width=100 height=100 alt="Mani Kumar Singh" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.linkedin.com/in/mani-kumar-singh-783644190" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Mani Kumar Singh</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91-7979846229</h4>
		<h4 style="font-family:'typo' ">manisinghasd@gmail.com</h4>
		<h4 style="font-family:'typo' ">National Institute of Technology,Calicut</h4></div></div>
		</p>
      </div>
